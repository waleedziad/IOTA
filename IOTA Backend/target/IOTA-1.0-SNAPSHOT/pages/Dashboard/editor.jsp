	...
	<div id="container" class="row-fluid">
		...
		<div id="sidebar" class="nav-collapse collapse">
			...
			<ul>
				...
				<li><a class="" href="charts.html"><i class="icon-bar-chart"></i> Data Charts</a></li>
				...
				<div class="row-fluid">
                    ...
                    <div class="widget">
                    	<div class="widget-title">
                            ...
                            <span class="tools">
                    			<iframe style="width:99.5%; height:500px" src="ide.html"></iframe>
                            </span>							
                    </div>
					</div>
				</div>
