                                    ...
                                    <div class="stats-overview block clearfix">
                                        <div class="display stat ok huge">
                                            <span class="line-chart">
                                                <%
                                                    ArrayList<ArrayList<Integer>> points = (ArrayList<ArrayList<Integer>>) session.getAttribute("points");

                                                    for (int j = points.get(i).size() - 1; j >= 0; j--) {
                                                        String output = points.get(i).get(j) + "";
                                                        if (j - 1 >= 0) {
                                                            output += ", ";
                                                        }
                                                %>
                                            ...
                                            <div class="btn-toolbar no-top-space clearfix">
                                                <div class="btn-group" data-toggle="buttons-radio">
                                                    <%
                                                        for (int i = 0; i < devicesInfo.size(); i++) {
                                                    %>
                                                    <button class="btn btn-mini" onclick="handleDashboardCharts(<%=i%>)"><%=devicesInfo.get(i).device.getDeviceName()%></button>
                                                    <%}
                                                    %>		
                                                </div>
