...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <script type="text/javascript">
        ...
        function checkForm(form)
        {
            if (form.devicename.value == "") {
                alert("Error: Device name cannot be blank!");
    ...
    <body>
        ...
        <div id="login">
            ...
            <!-- BEGIN LOGIN FORM -->
            <form id="loginform" class="form-vertical no-padding no-margin" method="POST" action="adddevice.htm" onsubmit="return checkForm(this);">
                <input type="hidden" name="userId" value="<%=userId%>" />
                <p class="center">Add Device</p>
                <div class="control-group">
                    <div class="controls">
                        <div class="input-prepend">
                            <span class="add-on"><i class="icon-desktop"></i></span><input id="input-devicename" name="devicename" type="text" placeholder="Device Name" />
                        </div>
                    </div>
                </div>
